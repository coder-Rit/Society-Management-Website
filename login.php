        ...
        <div class="container" id="container">
            <div class="form-container sign-up-container">
                <form action="register.php" method="post">
                    <h1 id="signin">Create Account</h1>
                    <div class="social-container">
                        <a href="#" class="social"><img src="Feature images/facebook.png" alt="Facebook"></a>
                        <a href="#" class="social"><img src="Feature images/google.png" alt="Google"></a>
                        <a href="#" class="social"><img src="Feature images/twitter.png" alt="Twitter"></a>
                    </div>
                    <span>or use your email for registration</span>
                    <input type="text" id="name" placeholder="Name" required name="name"/>
                    <input type="tel" id="phone" placeholder="Phone Number" pattern="[0-9]{10}" required name="phone" />
                    <input type="email" class="email" placeholder="Email" required name="email"/>
                    <input type="password" class="password" placeholder="Password" name="password"/>
                    <div class="flatinfo">
                        <input type="number" id="flat" placeholder="Flat Number" name="flatnumber"/>
                        <input type="text" id="wing" placeholder="Wing" name="wing"/>
                    </div>
                    <select name="typeofuser" class="usertype">
                        <option value="Select" selected>Select Type of User</option>
                        <option value="Tenant">Tenant</option>
                        <option value="Committee Member">Committee Member</option>
                        <option value="Society Manager">Society Manager</option>
                    </select>
                    <button id="sign" type="submit" name="submit">Sign Up</button>
                </form>
            </div>
            <div class="form-container sign-in-container">
                <form action="signin.php" method="post">
                    ...
                    <input type="password" class="password" placeholder="Password" name="password"/>
                    <a href="#" class="fyg">Forgot your password?</a>
                    <button id="log" type="submit" name="login">Log In</button>
                </form>
            </div>
